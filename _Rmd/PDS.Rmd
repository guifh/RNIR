...
```{r beforePDS, fig.width = 9, fig.height = 4.5, fig.align='center'}
...
```{r PDSafter, fig.width = 9, fig.height = 4.5, fig.align='center'}
...
```{r PDScompar, fig.width = 9, fig.height = 4.5, fig.align='center'}
